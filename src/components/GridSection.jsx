    ...
    <section>
      <div className="custom_container">
        <div className="d-grid gridcls">
          ...
          {/* 2 */}
          <div className="griditems griditem2 sec4_bg_rgb br_10 px_52 h-100 d-flex flex-column justify-content-between">
            <div className="d-flex align-items-center justify-content-between pt-5">
              <p className=" ff_Segoe fw-semibold fs_xl clr_black">Exclusive</p>
          ...
          {/* 3 */}
          <div className="griditems griditem3 sec4_bg_rgb br_10 px_52 h-100 d-flex flex-column justify-content-between">
            <div className="d-flex align-items-center justify-content-between pt-5">
          ...
          {/* 4 */}
          <div className="griditems griditem4 sec4_bg_rgb br_10 px_52 h-100 d-flex flex-column justify-content-between">
            <div className="d-flex align-items-center justify-content-between pt-5">
              <p className=" ff_Segoe fw-semibold fs_xl clr_black">
                High <br /> net worth
              </p>
          ...
          {/* 5 */}
          <div className="griditems griditem5 sec4_bg_rgb br_10 px_52 h-100 d-flex flex-column justify-content-between">
            <div className="d-flex align-items-center justify-content-between pt-5">
              <p className=" ff_Segoe fw-semibold fs_xl clr_black">
                High propensity
                <br />
            ...
            <p className="pt-5"></p>
            <p className="pb-5 pt-5">
              Our combination of event-driven data, historical data, behavioral
              analytics, and real-time data results in the highest propensity
              prospects.
            </p>
          </div>
          {/* 6 */}
          <div className="griditems griditem6 h-100 bgdolle r_img position-relative cur_poi imgtrans_hovr">
          ...
          <Col sm={7} lg={3} className="p-1 "></Col>
        </div>
      </div>
    </section>
  );
